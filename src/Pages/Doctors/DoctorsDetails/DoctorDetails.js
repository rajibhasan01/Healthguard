        ...
        <div className="marginTop py-5">
            ...
            <div className="row my-5 mx-5 pt-md-5">
                <div className="bg-white col-12 col-md-6 col-lg-4">
                    <Card className="card-body-design">
                        <Card.Text className="text-muted d-flex justify-content-between">
                            <HashLink className="text-decoration-none text-info take-appointment read-more" to='/doctors'><CgIcon.CgChevronDoubleLeft className="fs-5 icon-background mb-0" /> Back to Prev page</HashLink>
                        </Card.Text>
                ...
                <div className="col-12 col-md-6 col-lg-8 text-design">
                    <h3 className="mx-5 mt-4 mb-5">Our professionals</h3>
                    <Card.Text className="mx-md-5 fs-5 text-dark">
                        ...
                        <img src="https://i.ibb.co/hgsFSbf/degree.jpg" className="w-100" alt="" />
                    </Card.Text>
